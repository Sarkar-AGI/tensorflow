...
TEST_P(XlaArrayImplHashTest, HashValuesDifferentLayouts) {
  ...
  if (**actual_layout0 != *layout0->pjrt_layout()) {
    GTEST_SKIP() << "Custom layout not supported";
  }
