...
// For example, a 2D module with shape [2, 3] will be flattened to a 1D
// module with shape [6] surrounded by bitcasts.
absl::Status FlattenCollectiveModuleTo1D(HloComputation* entry_computation);
